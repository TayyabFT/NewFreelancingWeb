...
const SocialListing = () => {
  return (
    <div className="bg-gradient-to-r from-gray-900 to-blue-900 min-h-screen flex flex-col items-center justify-center text-white">
      {/* Header Section */}
      <div className="text-center px-4">
        ...
        <button className="bg-blue-800 hover:bg-blue-400 text-white font-medium py-3 px-6 rounded-lg shadow-md transition">
          Learn more →
        </button>
      </div>
