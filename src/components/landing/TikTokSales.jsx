  ...
  return (
    <div className="bg-white py-12 px-4">
      ...
      <div className="container mx-auto max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Card 1 */}
        <div className="bg-blue-900 text-white rounded-lg p-6 flex flex-col items-center justify-center">
        ...
        {/* Card 2 */}
        <div className="bg-blue-100 text-blue-900 rounded-lg p-6 flex flex-col items-center justify-center">
          <p className="text-sm font-medium mb-2">Avg Increase in sales</p>
          <div className="flex items-center space-x-2 text-4xl font-bold">
            <FaArrowUp className="text-blue-900 text-base" />
            <span>36%</span>
          </div>
        </div>
      </div>
